...
class LeaderShipMentorsController {
    ...
    static async getAllMentors(req, res) {
        try {
            ...
            // -----------------------------
            filter.mentorCategory = "Leadership Mentors";
            ...
            return helper.success(res, "LeaderShip mentors fetched successfully", {
                total,
                page: Number(page),
                limit: Number(limit),
...
export default LeaderShipMentorsController;
