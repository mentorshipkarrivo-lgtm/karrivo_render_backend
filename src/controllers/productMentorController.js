...
class ProductMentorsController {
    ...
    static async getAllMentors(req, res) {
        try {
            ...
            // -----------------------------
            filter.mentorCategory = "Product Mentors";
            ...
            return helper.success(res, "Product mentors fetched successfully", {
                total,
                page: Number(page),
                limit: Number(limit),
...
export default ProductMentorsController;
